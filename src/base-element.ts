...
export class BaseLit extends LitElement {
    ...
    protected scrollToY(scrollTargetY = 0, time = 600, easing: string = 'easeOutSine', target: HTMLElement | Window): void {
        ...
        const easingEquations: any = {
            ...
            'easeInOutSine': (pos: number): number => (-0.5 * (Math.cos(Math.PI * pos) - 1)),
        ...
        function tick() {
            ...
            const scrollTop = (target as Window).pageYOffset || (target as HTMLElement).scrollTop || 0;
